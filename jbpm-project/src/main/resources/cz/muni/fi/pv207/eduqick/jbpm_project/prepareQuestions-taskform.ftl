<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("questions");
					i++;
...
<div id="container">
	<div id="header">
		User Task Form: Closure course.prepareQuestions
	</div>
	<div id="content">
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<div class="div_texbox">
                              		<input name="questions" type="text" class="textbox" id="questions" value="${questions}" />
                            		</div>
