<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("company");
					i++;
...
<div id="container">
	<div id="header">
		User Task Form: Registration.selectCompany
	</div>
	<div id="content">
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<div class="div_texbox">
                              		<input name="company" type="text" class="textbox" id="company" value="${company}" />
                            		</div>
